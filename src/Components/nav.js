...
<li>
<Link to="/profilepage">Profile Page TEST LOL</Link> {/* Be sure to update this properly once finalized - Johnny */}
</li>
<li>
<Link to="/login">JOSEPH LOGIN TEST </Link> {/* Be sure to update this properly once finalized - Johnny */}
</li>
          </ul>
        </nav>
